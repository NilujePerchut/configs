...
call SpaceNeovimNMap('w-', 'split-window-below', 'rightbelow split')
call SpaceNeovimNMap('w/', 'split-window-right', 'rightbelow vsplit')
...
call SpaceNeovimNMap('wr', 'window-rotate', 'wincmd r')
...
if has('nvim')
  ...
  call SpaceNeovimBind('tmap', 'wr', 'window-rotate', 'wincmd r', 1)
endif
